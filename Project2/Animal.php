...
<div>
    ...
    <div>
        ...
        <ul class="theme">
            <h2 >热门主题快速浏览</h2>
            <li><a href="" onclick="myFunction()">Building</a></li>
            <li><a href="" onclick="myFunction()"style="color: #ec971f">Animal</a></li>
...
<footer>
    <div >
        <ul class="page">
            ...
            if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
            $start_from = ($page-1) * $num_rec_per_page;
            $sql = "SELECT * FROM travelimage WHERE Content = 'Animal'";
            ...
            echo "<a href='Animal.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='Animal.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='Animal.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
