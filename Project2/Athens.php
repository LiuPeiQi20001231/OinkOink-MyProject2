...
$sql = "SELECT * FROM travelimage WHERE CityCode = '264371' LIMIT $start_from, $num_rec_per_page";
...
<div>
    ...
    <div>
        ...
        <ul class="country">
            ...
            <li><a href="Athens.php" onclick="myFunction()" style="color: #ec971f">Athens</a></li>
...
<footer>
    <div >
        <ul class="page">
            ...
            echo "<a href='Athens.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='Athens.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='Athens.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
