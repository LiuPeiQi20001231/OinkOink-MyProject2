...
WHERE  Country_RegionCodeISO = 'BS'
...
<div>
    ...
    <div>
        ...
        <ul class="city">
            ...
            <li><a href="Bahamas" onclick="myFunction()"style="color: #ec971f" >Bahamas</a></li>
        </ul>
    </div>
    <div>
        <hr width="430" align="left" height="10" color="black">
...
<footer>
    <div >
        <ul class="page">
            ...
            if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
            $start_from = ($page-1) * $num_rec_per_page;
            $sql = "SELECT * FROM travelimage WHERE Country_RegionCodeISO = 'BS'";
            ...
            echo "<a href='Bahamas.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='Bahamas.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='Bahamas.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
