...
WHERE Country_RegionCodeISO = 'GH'
...
<div>
    ...
    <div>
        ...
        <ul class="city">
            ...
            <li><a href="Ghana.php" onclick="myFunction()" style="color: #ec971f">Ghana</a></li>
...
<footer>
    <div >
        <ul class="page">
            ...
            if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
            $start_from = ($page-1) * $num_rec_per_page;
            $sql = "SELECT * FROM travelimage WHERE Country_RegionCodeISO = 'GH'";
            ...
            echo "<a href='Ghana.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='Ghana.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='Ghana.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
