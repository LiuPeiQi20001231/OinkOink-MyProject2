...
WHERE  Country_RegionCodeISO = 'IT'
...
<div>
    ...
    <div>
        ...
        <ul class="city">
            ...
            <li><a href="Italy.php"  onclick="myFunction()" style="color: #ec971f">Italy</a></li>
...
<footer>
    <div >
        <ul class="page">
            ...
            echo "<a href='Italy.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='Italy.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='Italy.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
