...
<div>
    ...
    <div>
        ...
        <ul class="theme">
            ...
            <li><a href="" onclick="myFunction()" style="color: #ec971f">Other</a></li>
        </ul>
    </div>
...
<footer>
    <div >
        <ul class="page">
            ...
            if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
            $start_from = ($page-1) * $num_rec_per_page;
            $sql = "SELECT * FROM travelimage WHERE Content = 'Other'";
            ...
            echo "<a href='Other.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='Other.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='Other.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
