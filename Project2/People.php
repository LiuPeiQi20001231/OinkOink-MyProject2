...
<div>
    ...
    <div>
        ...
        <ul class="theme">
            ...
            <li><a href="" onclick="myFunction()" style="color: #ec971f">People</a></li>
...
<footer>
    <div >
        <ul class="page">
            ...
            echo "<a href='People.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='People.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='People.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
