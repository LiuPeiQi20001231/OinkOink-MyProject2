...
WHERE  Country_RegionCodeISO = 'GB'
...
<div>
    ...
    <div>
        ...
        <ul class="city">
            <h2>热门国家快速浏览</h2>
            <li><a href="United%20Kindom.php" onclick="myFunction()" style="color: #ec971f">United Kingdom</a></li>
...
<footer>
    <div >
        <ul class="page">
            ...
            echo "<a href='United%20Kindom.php?page=1' >".'|<'."</a> "; // 第一页

            for ($i=1; $i<=$total_pages; $i++) {
                echo "<a   href='United%20Kindom.php?page=".$i."' id='current' >".$i."</a> ";
            };
            echo "<a href='United%20Kindom.php?page=$total_pages' >".'>|'."</a> "; // 最后一页
